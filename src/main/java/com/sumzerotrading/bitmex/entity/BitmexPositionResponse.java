...
public class BitmexPositionResponse {

    protected BitmexPosition[] data;
    protected String table;

    public BitmexPosition[] getData() {
        return data;
    }

    public void setData(BitmexPosition[] data) {
        this.data = data;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BitmexPositionResponse other = (BitmexPositionResponse) obj;
